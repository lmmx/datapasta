...
def text_to_pandas(text: str, separator: Optional[str] = None, max_rows: int = 200) -> str:
...
def text_to_polars(text: str, separator: Optional[str] = None, max_rows: int = 200) -> str:
...
def clipboard_to_pandas(separator: Optional[str] = None, max_rows: int = 200) -> str:
...
def clipboard_to_polars(separator: Optional[str] = None, max_rows: int = 200) -> str:
